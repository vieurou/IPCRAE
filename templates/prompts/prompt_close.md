...
- [ ] Documentation mise à jour si code/méthode changés (README, docs/conception/, templates DEV sync)
- [ ] Knowledge/ mis à jour si connaissance réutilisable émergée (howto, pattern, runbook, zettelkasten)
